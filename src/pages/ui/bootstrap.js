						...
						<div className="col-xl-9">
							...
							<div id="alert" className="mb-5">
								...
								<p>
									...
									Please read the <a href="https://getbootstrap.com/docs/5.2/components/alerts/" target="_blank" rel="noreferrer">official Bootstrap documentation</a> for the full list of options.
								</p>
								<Card>
									<CardBody>
							...
							<div id="badge" className="mb-5">
								<h4>Badges</h4>
								<p>Documentation and examples for badges, our small count and labeling component. Please read the <a href="https://getbootstrap.com/docs/5.2/components/badge/" target="_blank" rel="noreferrer">official Bootstrap documentation</a> for the full list of options.</p>
								<Card>
									<CardBody>
										<div>
							...
							<div id="breadcrumb" className="mb-5">
								<h4>Breadcrumb</h4>
								<p>Indicate the current page’s location within a navigational hierarchy that automatically adds separators via CSS. Please read the <a href="https://getbootstrap.com/docs/5.2/components/breadcrumb/" target="_blank" rel="noreferrer">official Bootstrap documentation</a> for the full list of options.</p>
								<Card>
									<CardBody>
							...
							<div id="carousel" className="mb-5">
								<h4>Carousel</h4>
								<p>A slideshow component for cycling through elements—images or slides of text—like a carousel. Please read the <a href="https://getbootstrap.com/docs/5.2/components/carousel/" target="_blank" rel="noreferrer">official Bootstrap documentation</a> for the full list of options.</p>
								<Card>
									<CardBody>
							...
							<div id="jumbotron" className="mb-5">
								...
								<Card>
									<CardBody>
										<div className="p-5 bg-white bg-opacity-25 mb-0 rounded-3">
											<h1 className="display-4">Hello, world!</h1>
											<p className="lead">This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p>
											<hr className="my-4" />
											<p>It uses utility classes for typography and spacing to space content out within the larger container.</p>
											<a className="btn btn-outline-theme btn-lg" href="#/" role="button">Learn more</a>
										</div>
									</CardBody>
									<div className="hljs-container">
							...
							<div id="listGroup" className="mb-5">
								<h4>List Group</h4>
								<p>List groups are a flexible and powerful component for displaying a series of content. Please read the <a href="https://getbootstrap.com/docs/5.2/components/list-group/" target="_blank" rel="noreferrer">official Bootstrap documentation</a> for the full list of options.</p>
								<Card>
									<CardBody>
										<div className="row">
								...
								<Card>
									<CardBody>
										<div className="row">
											...
											<div className="col-xl-6">
												<div className="mb-2 small text-white text-opacity-50"><b>VERTICAL NAV</b></div>
							...
							<div id="navbar" className="mb-5">
								<h4>Narbar</h4>
								<p>Includes support for branding, navigation, and more, including support for collapse plugin. Please read the <a href="https://getbootstrap.com/docs/5.2/components/navbar/" target="_blank" rel="noreferrer">official Bootstrap documentation</a> for the full list of options.</p>
								<Card>
									<CardBody>
										<nav className="navbar navbar-expand-lg navbar-light bg-white bg-opacity-25 mb-3 rounded">
										...
										<nav className="navbar navbar-expand-lg navbar-dark bg-black bg-opacity-25 rounded">
											<div className="container-fluid">
												...
												<div className="collapse navbar-collapse" id="navbarDark">
													...
													<form className="d-flex">
														<input className="form-control me-sm-2 border-0 bg-white-transparent-2" type="search" placeholder="Search" />
							...
							<div id="pagination" className="mb-5">
								<h4>Pagination</h4>
								<p>Documentation and examples for showing pagination to indicate a series of related content exists across multiple pages. Please read the <a href="https://getbootstrap.com/docs/5.2/components/pagination/" target="_blank" rel="noreferrer">official Bootstrap documentation</a> for the full list of options.</p>
								<Card>
									<CardBody>
							...
							<div id="progress" className="mb-5">
								<h4>Progress</h4>
								<p>Documentation and examples for using Bootstrap custom progress bars featuring support for stacked bars, animated backgrounds, and text labels. Please read the <a href="https://getbootstrap.com/docs/5.2/components/progress/" target="_blank" rel="noreferrer">official Bootstrap documentation</a> for the full list of options.</p>
								<Card>
									<CardBody>
										<div className="row">
											<div className="col-xl-6">
												<div className="mb-3">
													<div className="mb-2 small text-white text-opacity-50"><b>DEFAULT</b></div>
													<div className="progress">
														<div className="progress-bar" style={{width: '50%'}}>50%</div>
													</div>
												</div>
												<div className="mb-3">
													<div className="mb-2 small text-white text-opacity-50"><b>MULTIPLE BARS</b></div>
													<div className="progress">
											...
											<div className="col-xl-6">
												<div className="mb-3">
													<div className="mb-2 small text-white text-opacity-50"><b>STRIPED</b></div>
													<div className="progress">
														<div className="progress-bar progress-bar-striped" style={{width: '66%'}}>66%</div>
													</div>
												</div>
												<div className="mb-3">
													<div className="mb-2 small text-white text-opacity-50"><b>ANIMATED</b></div>
													<div className="progress">
							...
							<div id="spinners" className="mb-5">
								<h4>Spinners</h4>
								<p>Indicate the loading state of a component or page with Bootstrap spinners, built entirely with HTML, CSS, and no JavaScript. Please read the <a href="https://getbootstrap.com/docs/5.2/components/spinners/" target="_blank" rel="noreferrer">official Bootstrap documentation</a> for the full list of options.</p>
								<Card>
									<CardBody className="pb-0">
										<div className="row">
											<div className="col-xl-6">
												<div className="mb-4">
													<div className="mb-2 small text-white text-opacity-50"><b>BORDER SPINNER</b></div>
													<div className="spinner-border"></div>
												</div>
												<div className="mb-4">
													<div className="mb-2 small text-white text-opacity-50"><b>COLORS</b></div>
												...
												<div className="mb-4">
													<div className="mb-2 small text-white text-opacity-50"><b>SIZE</b></div>
											...
											<div className="col-xl-6">
												<div className="mb-4">
													<div className="mb-2 small text-white text-opacity-50"><b>GROWING SPINNER</b></div>

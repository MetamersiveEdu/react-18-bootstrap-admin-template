						...
						<div className="col-xl-9">
							...
							<div id="basicUsage" className="mb-5">
								...
								<p>
									...
									Please read the <a href="https://getbootstrap.com/docs/5.2/components/card/" target="_blank" rel="noreferrer">official Bootstrap documentation</a> for the full list of options.
								</p>
								<Card>
									<CardBody>
										<div className="row">
							...
							<div id="navigation" className="mb-5">
								...
								<Card>
									<CardBody>
										<div className="row">
											<div className="col-xl-6">
												<div className="small text-white text-opacity-50 mb-3 fw-bold">NAV TABS</div>
												<Card className="mb-3">
													<CardHeader>
											...
											<div className="col-xl-6">
												<div className="small text-white text-opacity-50 mb-3 fw-bold">NAV PILLS</div>
												<Card className="mb-3">
													<CardHeader>
							...
							<div id="images" className="mb-5">
								...
								<Card>
									<CardBody>
										<div className="row">
											<div className="col-xl-6">
												<div className="small text-white text-opacity-50 mb-3 fw-bold">IMAGE CAPS</div>
												<Card className="mb-3">
											...
											<div className="col-xl-6">
												<div className="small text-white text-opacity-50 mb-3 fw-bold">IMAGE OVERLAY</div>
							...
							<div id="cardStyles" className="mb-5">
								...
								<Card>
									<CardBody>
										<div className="row">
											<div className="col-xl-6">
												<div className="small text-white text-opacity-50 mb-3 fw-bold">BACKGROUND AND BORDER</div>
												<Card className="border-theme bg-theme bg-opacity-25 mb-3">
													<CardHeader className="border-theme fw-bold small text-white">HEADER</CardHeader>
													<CardBody>
														<h5 className="card-title">Primary card title</h5>
														<p className="card-text text-white text-opacity-75">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
													</CardBody>
												</Card>
											</div>
											<div className="col-xl-6">
												<div className="small text-white text-opacity-50 mb-3 fw-bold">BORDER AND COLOR</div>

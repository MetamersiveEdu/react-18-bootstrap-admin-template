						...
						<div className="col-xl-9">
							...
							<div id="tabs" className="mb-5">
								...
								<p>
									...
									Please read the <a href="https://getbootstrap.com/docs/5.2/components/navs/#tabs" target="_blank" rel="noreferrer">official Bootstrap documentation</a> for the full list of options.
								</p>
								<Card>
									<CardBody>
							...
							<div id="accordion" className="mb-5">
								<h4>Accordion</h4>
								<p>
									Build vertically collapsing accordions in combination with Bootstrap Collapse JavaScript plugin. Please read the <a href="https://getbootstrap.com/docs/5.2/components/accordion/" target="_blank" rel="noreferrer">official Bootstrap documentation</a> for the full list of options.
								</p>
								<Card>
									<CardBody>

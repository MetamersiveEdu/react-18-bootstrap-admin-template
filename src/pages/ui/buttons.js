						...
						<div className="col-xl-9">
							...
							<div id="classes" className="mb-5">
								...
								<p>
									...
									Please read the <a href="https://getbootstrap.com/docs/5.2/components/buttons/" target="_blank" rel="noreferrer">official Bootstrap documentation</a> for the full list of options.
								</p>
								<Card>
									<CardBody>
										<button type="button" className="btn btn-theme">Theme</button>
										<hr />
										<button type="button" className="btn me-1 btn-default mb-1">Default</button>
										<button type="button" className="btn me-1 btn-secondary mb-1">Secondary</button>
										<button type="button" className="btn me-1 btn-dark mb-1">Dark</button>
										<button type="button" className="btn me-1 btn-info mb-1">Info</button>
										<button type="button" className="btn me-1 btn-primary mb-1">Primary</button>
										<button type="button" className="btn me-1 btn-purple mb-1">Purple</button>
										<button type="button" className="btn me-1 btn-indigo mb-1">Indigo</button>
										<button type="button" className="btn btn-link mb-1">Link</button>
										<span className="d-lg-inline d-none"><br /></span>
										<button type="button" className="btn me-1 btn-danger mb-1">Danger</button>
										<button type="button" className="btn me-1 btn-pink mb-1">Pink</button>
										<button type="button" className="btn me-1 btn-warning mb-1">Warning</button>
										<button type="button" className="btn me-1 btn-yellow mb-1">Yellow</button>
										<button type="button" className="btn me-1 btn-lime mb-1">Lime</button>
										<button type="button" className="btn me-1 btn-green mb-1">Green</button>
										<button type="button" className="btn btn-success mb-1">Success</button>
									</CardBody>
							...
							<div id="outlineButtons" className="mb-5">
								...
								<Card>
									<CardBody>
										...
										<hr />
										<button type="button" className="btn me-1 btn-outline-default mb-1">Default</button>
										<button type="button" className="btn me-1 btn-outline-secondary mb-1">Secondary</button>
										<button type="button" className="btn me-1 btn-outline-dark mb-1">Dark</button>
										<button type="button" className="btn me-1 btn-outline-info mb-1">Info</button>
										<button type="button" className="btn me-1 btn-outline-primary mb-1">Primary</button>
										<button type="button" className="btn me-1 btn-outline-purple mb-1">Purple</button>
										<button type="button" className="btn me-1 btn-outline-indigo mb-1">Indigo</button>
										<button type="button" className="btn btn-outline-link mb-1">Link</button>
										<br />
										<button type="button" className="btn me-1 btn-outline-danger mb-1">Danger</button>
										<button type="button" className="btn me-1 btn-outline-pink mb-1">Pink</button>
										<button type="button" className="btn me-1 btn-outline-warning mb-1">Warning</button>
										<button type="button" className="btn me-1 btn-outline-yellow mb-1">Yellow</button>
										<button type="button" className="btn me-1 btn-outline-lime mb-1">Lime</button>
										<button type="button" className="btn me-1 btn-outline-green mb-1">Green</button>
										<button type="button" className="btn btn-outline-success mb-1">Success</button>
									</CardBody>
									<div className="hljs-container">
							...
							<div id="sizes" className="mb-5">
								...
								<Card>
									<CardBody className="pb-0">
										<div className="mb-4">
											<div className="mb-2 small text-white text-opacity-50">
												<b>LARGE BUTTON</b>
											</div>

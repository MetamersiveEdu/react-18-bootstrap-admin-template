...
import { Card, CardHeader, CardBody, CardImgOverlay, CardFooter } from './../../components/card/card.jsx';
...
function Widgets() {
	...
	function renderChart() {
		...
		chart1 = new Chart(document.getElementById('widgetBarChart'), {
			type: 'bar',
			data: {
									...
									<CardBody>
										<div className="row">
											<div className="col-xl-8">
												<Card className="text-white p-5px">
													<div style={{maxHeight: '250px'}} className="overflow-hidden">
														<img src="/assets/img/gallery/widget-cover-1.jpg" alt="" className="card-img" />
													</div>
													<CardImgOverlay className="d-flex flex-column bg-gray-600 bg-opacity-75 m-5px" style={{zIndex: 20}}>
									...
									<CardBody>
										<div className="row">
											<div className="col-xl-6">
												<div className="text-white text-opacity-50 small mb-2"><b>WITH ICON</b></div>
												<div className="list-group mb-3">
													<div className="list-group-item d-flex align-items-center">
														<div className="w-40px h-40px d-flex align-items-center justify-content-center bg-gradient-cyan-blue text-white rounded-2 ms-n1">
															<i className="fab fa-apple fa-lg"></i>
														</div>
														<div className="flex-fill px-3">
															<div className="fw-bold">Apps Store</div>
															<div className="small text-white text-opacity-50">102 new download</div>
														</div>
													...
													<div className="list-group-item d-flex align-items-center">
														...
														<div className="flex-fill px-3">
															...
															<div className="small text-white text-opacity-50">32 new download</div>
														</div>
														<div className="dropdown">
															<a href="#/" data-bs-toggle="dropdown" className="text-white text-opacity-50"><i className="fa fa-ellipsis-h"></i></a>
															<div className="dropdown-menu dropdown-menu-end">
												...
												<div className="text-white text-opacity-50 small mb-2"><b>WITH IMAGE</b></div>
												<div className="list-group mb-3">
													<a href="#/" className="list-group-item list-group-item-action d-flex align-items-center text-white">
														...
														<div className="flex-fill ps-3">
															<div className="fw-bold">
																Isaiah Hughes <span className="fa fa-circle text-success fs-9px ms-2"></span>
															</div>
														</div>
													</a>
													<a href="#/" className="list-group-item list-group-item-action d-flex align-items-center text-white">
														...
														<div className="flex-fill ps-3">
															<div className="fw-bold">
																Ryan Turner <span className="fa fa-circle text-white text-opacity-50 fs-9px ms-2"></span>
															</div>
														</div>
													</a>
												</div>
											...
											<div className="col-xl-6">
												<div className="text-white text-opacity-50 small mb-2"><b>WITH SETTINGS</b></div>
												<div className="list-group">
													<div className="list-group-item d-flex align-items-center">
														<div className="flex-fill">
															<div className="fw-bold">Server auto backup</div>
															<div className="small text-white text-opacity-50">last backup since yesterday</div>
														</div>
														<div>
													...
													<div className="list-group-item d-flex align-items-center">
														<div className="flex-fill">
															...
															<div className="small text-white text-opacity-50">3,392 data collected</div>
														</div>
														<div>
										...
										<div className="row">
											<div className="col-xl-8">
												<Card className="text-decoration-none">
													<CardBody className="d-flex align-items-center text-white m-5px bg-white bg-opacity-15">
														<div className="flex-fill">
											...
											<div className="col-xl-8">
												<Card>
													<CardBody className="text-white text-center">
														...
														<canvas id="widgetBarChart" height="120"></canvas>
													</CardBody>
													<hr className="m-0" />
										...
										<div className="row">
											<div className="col-xl-8">
												<Card>
													...
													<CardBody className="bg-white bg-opacity-15 p-0">
														...
														<div className="position-relative overflow-hidden" style={{height: '165px'}}>
															...
															<CardImgOverlay className="text-white text-center bg-dark-transparent-5">
																...
																<div>
																	...
																	<div className="fs-12px">Never give up</div>
																</div>
															</CardImgOverlay>
														</div>
												...
												<div className="list-group">
													<a href="#/" className="list-group-item list-group-item-action d-flex align-items-center text-white">
														...
														<div className="flex-fill px-3">
															...
															<div className="small text-white text-opacity-50">Apple</div>
													...
													<div className="list-group list-group-flush">
														<a href="#/" className="list-group-item list-group-item-action d-flex align-items-center text-white">
															<div className="flex-fill pe-3">
																...
																<div className="small text-white text-opacity-50">3,192 Image Found</div>
															</div>
															<div>
																<i className="fa fa-chevron-right fa-lg text-white text-opacity-50"></i>
															</div>
														</a>
													</div>
													<hr className="m-0" />

										...
										<div className="list-group list-group-flush">
											<div className="list-group-item d-flex align-items-center">
												<div className="flex-1 text-break">
													<div>Name</div>
													<div className="text-white text-opacity-50">Sean Ngu</div>
												</div>
											...
											<div className="list-group-item d-flex align-items-center">
												<div className="flex-1 text-break">
													<div>Username</div>
													<div className="text-white text-opacity-50">@seantheme</div>
												</div>
												<div>
													<a href="#modalEdit" data-bs-toggle="modal" className="btn btn-outline-default w-100px">Edit</a>
												</div>
											...
											<div className="list-group-item d-flex align-items-center">
												<div className="flex-1 text-break">
													<div>Phone</div>
													<div className="text-white text-opacity-50">+1-202-555-0183</div>
												</div>
												<div>
													<a href="#modalEdit" data-bs-toggle="modal" className="btn btn-outline-default w-100px">Edit</a>
												</div>
											...
											<div className="list-group-item d-flex align-items-center">
												<div className="flex-1 text-break">
													...
													<div className="text-white text-opacity-50">support@seantheme.com</div>
												</div>
												<div>
													<a href="#modalEdit" data-bs-toggle="modal" className="btn btn-outline-default w-100px">Edit</a>
												</div>
									...
									<Card>
										<div className="list-group list-group-flush">
											...
											<div className="list-group-item d-flex align-items-center">
												<div className="flex-1 text-break">
													<div>Firewall</div>
													<div className="text-white text-opacity-50 d-block d-xl-flex align-items-center">

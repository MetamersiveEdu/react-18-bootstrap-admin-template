...
function ChartApex() {
	...
	function getColumnChartOptions() {
		...
		return {
			...
			yaxis: { title: { text: '$ (thousands)' }, labels: { style: { colors: '#ffffff', fontSize: '12px', fontFamily: themeFont, fontWeight: themeFontWeight, cssClass: 'apexcharts-xaxis-label' } } },
			fill: { opacity: 1 },
	...
	function getCandlestickChartOptions() {
		...
		return {
			title: { text: 'CandleStick Chart', align: 'left', style: { fontSize:  '14px', fontWeight:  'bold', fontFamily:  themeFont, color:  '#ffffff' } },
			xaxis: {
				type: 'datetime',
				axisBorder: { show: true, color: gray300, height: 1, width: '100%', offsetX: 0, offsetY: -1 },
				axisTicks: { show: true, borderType: 'solid', color: gray300, height: 6, offsetX: 0, offsetY: 0 },
			...
			yaxis: { tooltip: { enabled: true }, labels: { style: { colors: '#ffffff', fontSize: '12px', fontFamily: themeFont, fontWeight: themeFontWeight, cssClass: 'apexcharts-xaxis-label' } } }
		};
	}
	...
	function getScatterChartOptions() {
		...
		return {
			...
			colors: [themeColor, orange, 'rgba(255, 255, 255, .5)'],
			legend: { fontFamily: themeFont, labels: { colors: '#ffffff' } },
			xaxis: { 
				tickAmount: 10, 
				labels: { 
			...
			yaxis: { tickAmount: 7, labels: { style: { colors: '#ffffff', fontSize: '12px', fontFamily: themeFont, fontWeight: themeFontWeight, cssClass: 'apexcharts-xaxis-label' } } }
		};
	}

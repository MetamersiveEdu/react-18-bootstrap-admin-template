	...
	return (
		<div>
			...
			<div className="mb-3 d-md-flex fw-bold">
				<div className="mt-md-0 mt-2"><a href="#/" className="text-decoration-none text-white"><i className="bi bi-printer fa-fw me-1 text-white text-opacity-50"></i> Print</a></div>
				<div className="ms-md-4 mt-md-0 mt-2"><a href="#/" className="text-decoration-none text-white"><i className="bi bi-boxes fa-fw me-1 text-white text-opacity-50"></i> Restock items</a></div>
				<div className="ms-md-4 mt-md-0 mt-2"><a href="#/" className="text-decoration-none text-white"><i className="bi bi-pen fa-fw me-1 text-white text-opacity-50"></i> Edit</a></div>
				<div className="ms-md-4 mt-md-0 mt-2 dropdown-toggle">
					<a href="#/" data-bs-toggle="dropdown" className="text-decoration-none text-white"><i className="bi bi-gear fa-fw me-1 text-white text-opacity-50"></i> More Actions</a>
			...
			<div className="row gx-4">
				<div className="col-lg-8">
					<Card className="mb-4">
						<CardHeader className="d-flex align-items-center bg-white bg-opacity-15 fw-400">
							Products (3)
							<a href="#/" className="ms-auto text-decoration-none text-white text-opacity-50"><i className="bi bi-truck fa-lg me-1"></i> Add Tracking Link</a>
						</CardHeader>
						<CardBody className="text-white">
							<div className="row align-items-center">
								<div className="col-lg-8 d-flex align-items-center">
									<div className="h-65px w-65px d-flex align-items-center justify-content-center position-relative bg-white p-1">
										...
										<span className="w-20px h-20px p-0 d-flex align-items-center justify-content-center badge bg-theme text-white position-absolute end-0 top-0 fw-bold fs-12px rounded-pill mt-n2 me-n2">1</span>
									</div>
									<div className="ps-3 flex-1">
										<div><a href="#/" className="text-decoration-none text-white">iPhone 13 Pro Max</a></div>
							...
							<div className="row">
								<div className="col-lg-8 d-flex align-items-center">
									...
									<div className="ps-3 flex-1">
										<div className=""><a href="#/" className="text-decoration-none text-white">Macbook Pro 2020</a></div>
										<div className="text-white text-opacity-50 small">
											SKU: MACBOOKPRO-1TB
										</div>
									</div>
							...
							<div className="row">
								<div className="col-lg-8 d-flex align-items-center">
									...
									<div className="ps-3 flex-1">
										<div className=""><a href="#/" className="text-decoration-none text-white">Apple Watch 5</a></div>
										<div className="text-white text-opacity-50 small">
											SKU: APPLEWATCHBLACK
										</div>
									</div>
								...
								<div className="col-lg-2 text-white m-0 text-end">
									$599
								</div>
							</div>
						</CardBody>
					...
					<Card>
						<CardHeader className="d-flex align-items-center bg-white bg-opacity-15 fw-400">
							Payment Records
							<a href="#/" className="ms-auto text-decoration-none text-white text-opacity-50"><i className="bi bi-paypal me-1 fa-lg"></i> View paypal records</a>
						</CardHeader>
						<CardBody>
				...
				<div className="col-lg-4">
					<Card className="mb-4">
						<CardHeader className="d-flex align-items-center bg-white bg-opacity-15 fw-400">
							Notes
							<a href="#/" className="ms-auto text-decoration-none text-white text-opacity-50">Edit</a>
						</CardHeader>
						<CardBody>

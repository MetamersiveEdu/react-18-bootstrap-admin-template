		...
		<div>
			...
			<div className="row gx-4">
				<div className="col-lg-8">
					...
					<Card className="mb-4">
						...
						<CardBody>
							...
							<div className="row mb-3 fw-bold text-white">
				...
				<div className="col-lg-4">
					<Card className="mb-4">
						<CardHeader className="d-flex align-items-center fw-400 bg-white bg-opacity-15">
						...
						<CardBody>
							<div className="d-flex">
								<div className="flex-1 d-flex">
									<div className="me-2"><i className="fa fa-store fa-lg fa-fw text-white text-opacity-50"></i></div>
									<div>Online Store</div>
									<span className="badge bg-white bg-opacity-15 text-theme fw-bold fs-12px ms-auto me-2">2022-01-05</span>
								</div>
							...
							<div className="d-flex">
								<div className="flex-1 d-flex">
									<div className="me-2"><i className="fab fa-shopify fa-lg fa-fw text-white text-opacity-50"></i></div>
									<div>Shopify</div>
									<span className="badge bg-white bg-opacity-15 text-theme fw-bold fs-12px ms-auto me-2">2022-01-05</span>
								</div>
								<div className="w-50px text-center"><a href="#/" className="text-decoration-none"><i className="bi bi-calendar fa-lg"></i></a></div>
							...
							<div className="d-flex">
								<div className="flex-1 d-flex">
									<div className="me-2"><i className="fab fa-amazon fa-lg fa-fw text-white text-opacity-50"></i></div>
									<div>
										<div>Amazon</div>
										<div className="d-flex mt-1 text-white text-opacity-50 small">
								...
								<div className="w-50px text-center"><a href="#/" className="text-decoration-none text-white text-opacity-50"><i className="bi bi-x-circle-fill fa-lg fa-fw"></i></a></div>
							</div>
						</CardBody>
					</Card>
					<Card className="mb-4">
					...
					<Card className="mb-4">
						...
						<CardBody>
							...
							<p className="mb-0 small text-white text-opacity-50">

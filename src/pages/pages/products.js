	...
	return (
		<div>
			...
			<div className="mb-sm-4 mb-3 d-sm-flex">
				<div className="mt-sm-0 mt-2"><a href="#/" className="text-white text-opacity-75 text-decoration-none"><i className="fa fa-download fa-fw me-1 text-theme"></i> Export</a></div>
				<div className="ms-sm-4 mt-sm-0 mt-2"><a href="#/" className="text-white text-opacity-75 text-decoration-none"><i className="fa fa-upload fa-fw me-1 text-theme"></i> Import</a></div>
				<div className="ms-sm-4 mt-sm-0 mt-2 dropdown-toggle">
					<a href="#/" data-bs-toggle="dropdown" className="text-white text-opacity-75 text-decoration-none">More Actions</a>
									...
									<tr>
										...
										<td>
											<div className="d-flex align-items-center">
												...
												<div className="ms-3">
													<Link to="/pages/product-details" className="text-white text-opacity-75 text-decoration-none">Force Majeure White T Shirt</Link>
												</div>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div className="d-flex align-items-center">
												...
												<div className="ms-3">
													<Link to="/pages/product-details" className="text-white text-opacity-75 text-decoration-none">Eco-friendly fashion, organic cotton, slow fashion polo shirts</Link>
												</div>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div className="d-flex align-items-center">
												...
												<div className="ms-3">
													<Link to="/pages/product-details" className="text-white text-opacity-75 text-decoration-none">Nike Shoes (Red Color)</Link>
												</div>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div className="d-flex align-items-center">
												...
												<div className="ms-3">
													<Link to="/pages/product-details" className="text-white text-opacity-75 text-decoration-none">Nike Air Max (Blue Color)</Link>
												</div>
											</div>
										</td>
										<td className="align-middle">19 in stock for 1 variants</td>
									...
									<tr>
										...
										<td>
											<div className="d-flex align-items-center">
												...
												<div className="ms-3">
													<Link to="/pages/product-details" className="text-white text-opacity-75 text-decoration-none">Skate Sneaker (Orange Color)</Link>
												</div>
											</div>
										</td>
										<td className="align-middle">19 in stock for 1 variants</td>
									...
									<tr>
										...
										<td>
											<div className="d-flex align-items-center">
												...
												<div className="ms-3">
													<Link to="/pages/product-details" className="text-white text-opacity-75 text-decoration-none">Teen Fashion T-shirt (Black)</Link>
												</div>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div className="d-flex align-items-center">
												...
												<div className="ms-3">
													<Link to="/pages/product-details" className="text-white text-opacity-75 text-decoration-none">Levis Blue Jeans</Link>
												</div>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div className="d-flex align-items-center">
												...
												<div className="ms-3">
													<Link to="/pages/product-details" className="text-white text-opacity-75 text-decoration-none">Boots (White Color)</Link>
												</div>
											</div>
										</td>
										<td className="align-middle">19 in stock for 1 variants</td>
									...
									<tr>
										...
										<td>
											<div className="d-flex align-items-center">
												...
												<div className="ms-3">
													<Link to="/pages/product-details" className="text-white text-opacity-75 text-decoration-none">Hiking Boots</Link>
												</div>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div className="d-flex align-items-center">
												...
												<div className="ms-3">
													<Link to="/pages/product-details" className="text-white text-opacity-75 text-decoration-none">Dress (Pink)</Link>
												</div>
											</div>
										</td>

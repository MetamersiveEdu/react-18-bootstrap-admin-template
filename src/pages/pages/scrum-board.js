		...
		<div>
			...
			<div className="mb-md-4 mb-3 d-md-flex">
				<div className="dropdown-toggle">
					<a href="#/" data-bs-toggle="dropdown" className="text-white text-opacity-75 text-decoration-none"><i className="far fa-folder fa-fw fa-lg text-theme me-1"></i> project/hud</a>
						...
						<div className="list-group list-group-flush">
							<div className="list-group-item d-flex px-3">
								<div className="me-3 pt-1">
									<i className="far fa-question-circle text-white text-opacity-50 fa-fw fa-lg"></i> 
								</div>
								<div className="flex-fill">
									<div className="fw-400">Enable open search</div>
									<div className="small text-white text-opacity-50 mb-2">#29949 opened yesterday by Terry</div>
									<div>
										<span className="badge border border-gray-300 text-white text-opacity-50 me-1">docs</span>
									...
									<div className="d-flex align-items-center mb-2">
										...
										<div>
											<a href="#/" className="text-white text-opacity-50" data-bs-toggle="collapse" data-bs-target="#todoBoard">
							...
							<a href="#/" className="list-group-item list-group-item-action d-flex ps-3">
								...
								<div className="flex-fill">
									...
									<div className="small text-white text-opacity-50 mb-2">#29919 opened 9 days ago by xMediaKron</div>
									<div className="mb-1">
										<span className="badge border border-gray-300 text-white text-opacity-50 me-1">build</span>
							...
							<a href="#/" className="list-group-item list-group-item-action d-flex ps-3">
								...
								<div className="flex-fill">
									...
									<div className="small text-white text-opacity-50 mb-2">#29916 opened 9 days ago by Wasbbok</div>
							...
							<a href="#/" className="list-group-item list-group-item-action d-flex ps-3">
								...
								<div className="flex-fill">
									...
									<div className="small text-white text-opacity-50 mb-2">#29796 opened 29 days ago by mdo</div>
									<div className="mb-1">
							...
							<a href="#/" className="list-group-item list-group-item-action d-flex ps-3">
								...
								<div className="flex-fill">
									...
									<div className="mb-2 small text-white text-opacity-50">#29919 opened 19 days ago by sean</div>
									<div className="mb-1">
										<span className="badge border border-gray-300 text-white text-opacity-50 me-1">design</span>
				...
				<div className="col-xl-4 col-lg-6">
					<Card className="mb-3">
						...
						<div className="list-group list-group-flush">
							<div className="list-group-item d-flex px-3">
								<div className="me-3 pt-1">
									<i className="fa fa-tools text-white text-opacity-50 fa-fw fa-lg"></i> 
								</div>
								<div className="flex-fill">
									<div className="fw-400 lh-20">HTML5 flexbox old browser compatibility</div>
									<div className="small text-white text-opacity-50 mb-2">#29982 handled by Sean</div>
									<div className="mb-1">
									...
									<div className="d-flex align-items-center mb-2">
										...
										<div>
											<a href="#/" className="text-white text-opacity-50" data-bs-toggle="collapse" data-bs-target="#inProgressBoard">
												<i className="fa fa-plus-circle"></i>
											</a>
										</div>
										<div className="progress progress-xs w-100px me-2 ms-auto" style={{height: '6px'}}>
							...
							<div className="list-group-item d-flex px-3">
								...
								<div className="flex-fill">
									...
									<div className="text-white text-opacity-50 mb-2">#29953 handled by Ken</div>
									<div className="mb-1">
										<span className="badge border border-gray-300 text-white text-opacity-50 me-1">issue</span>
									...
									<div className="d-flex align-items-center mb-2">
										...
										<div>
											<a href="#/" className="text-white text-opacity-50" data-bs-toggle="collapse" data-bs-target="#inProgress2Board">
												<i className="fa fa-plus-circle"></i>
											</a>
										</div>
										<div className="progress progress-xs w-100px me-2 ms-auto" style={{height: '6px'}}>
							...
							<div className="list-group-item d-flex px-3">
								...
								<div className="flex-fill">
									...
									<div className="d-flex align-items-center mb-2">
										...
										<div>
											<a href="#/" className="text-white text-opacity-50" data-bs-toggle="collapse" data-bs-target="#completedBoard">
												<i className="fa fa-plus-circle"></i>
											</a>
										</div>
										<div className="progress progress-xs w-100px me-2 ms-auto" style={{height: '6px'}}>

						...
						<div className="pos-container">
														...
														<div className="pos-checkout-table-info small">
															<div className="row">
																<div className="col-6 d-flex justify-content-center">
																	<div className="w-20px"><i className="bi bi-people text-white text-opacity-50"></i></div>
																	<div className="w-60px">{table.pax} / {table.totalPax}</div>
																</div>
																<div className="col-6 d-flex justify-content-center">
																	<div className="w-20px"><i className="bi bi-clock text-white text-opacity-50"></i></div>
																	<div className="w-60px">{(table.totalTime) ? table.totalTime : '-'}</div>
																</div>
															</div>
															<div className="row">
																<div className="col-6 d-flex justify-content-center">
																	<div className="w-20px"><i className="bi bi-receipt text-white text-opacity-50"></i></div>
																	<div className="w-60px">${getTotalPrice(table.orders)}</div>
																</div>
																<div className="col-6 d-flex justify-content-center">
																	<div className="w-20px"><i className="bi bi-currency-dollar text-white text-opacity-50"></i></div>
							...
							<div className="pos-sidebar" id="pos-sidebar">
								<div className="pos-sidebar-header">
									...
									<div className="icon"><img src="/assets/img/pos/icon-table.svg" alt="" /></div>
								...
								<hr className="m-0 opacity-3 text-white" />
												...
												<div className="pos-order-product">
													...
													<div className="flex-1">
														<div className="row">
															...
															<div className="col-3 text-white fw-bold text-end">${ (parseFloat(order.price) * order.quantity).toFixed(2) }</div>
														</div>
													</div>
												</div>
											</div>

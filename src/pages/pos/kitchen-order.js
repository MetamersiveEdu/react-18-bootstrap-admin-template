					...
					<PerfectScrollbar className="pos-content-container h-100 p-0">
								...
								<div className="pos-task-info">
									...
									<div className="mb-2">
										<span className={'badge fs-14px' +
											...
											((order.orderStatus === 'Completed') ? ' bg-gray-500 text-white' : '')
						...
						<div className="pos-task">
							<div className="pos-task-info">
								...
								<div className="mb-2">
									<span className="badge bg-gray-500 text-white fs-14px">Dine-in</span>
								</div>
						...
						<div className="pos-task">
							<div className="pos-task-info">
								...
								<div className="mb-2">
									<span className="badge bg-gray-500 text-white fs-14px">Take Away</span>
								</div>

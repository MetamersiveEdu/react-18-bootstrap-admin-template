		...
		<Card className="h-100">
			<div className="mailbox">
				<div className="mailbox-toolbar">
					...
					<div className="mailbox-toolbar-item"><Link to="/email/compose" className="mailbox-toolbar-link text-white bg-white bg-opacity-15">New Message <i className="fa fa-pen fs-12px ms-1"></i></Link></div>
				</div>

					...
					<div className="profile-container">
						<div className="profile-sidebar">
							<div className="desktop-sticky-top">
								...
								<h4>John Smith</h4>
								<div className="mb-3 text-white text-opacity-50 fw-bold mt-n2">@johnsmith</div>
								<p>
								...
								<div className="mb-1">
									<i className="fa fa-map-marker-alt fa-fw text-white text-opacity-50"></i> New York, NY
								</div>
								<div className="mb-3">
									<i className="fa fa-link fa-fw text-white text-opacity-50"></i> seantheme.com/hud
								</div>
								...
								<div className="d-flex align-items-center mb-3">
									...
									<div className="flex-fill px-3">
										...
										<div className="fs-12px text-white text-opacity-50">3.1m followers</div>
									</div>
								...
								<div className="d-flex align-items-center mb-3">
									...
									<div className="flex-fill px-3">
										...
										<div className="fs-12px text-white text-opacity-50">302k followers</div>
									</div>
									<a href="#/" className="btn btn-sm btn-outline-theme fs-11px">Follow</a>
								</div>
								<div className="d-flex align-items-center mb-3">
									...
									<div className="flex-fill px-3">
										...
										<div className="fs-12px text-white text-opacity-50">720k followers</div>
									</div>
									<a href="#/" className="btn btn-sm btn-outline-theme fs-11px">Follow</a>
								</div>
								<div className="d-flex align-items-center mb-3">
									...
									<div className="flex-fill px-3">
										...
										<div className="fs-12px text-white text-opacity-50">1.4m followers</div>
									</div>
									<a href="#/" className="btn btn-sm btn-outline-theme fs-11px">Follow</a>
								</div>
								<div className="d-flex align-items-center">
									...
									<div className="flex-fill px-3">
										...
										<div className="fs-12px text-white text-opacity-50">989k followers</div>
									</div>
									<a href="#/" className="btn btn-sm btn-outline-theme fs-11px">Follow</a>
								</div>
							</div>
													...
													<CardBody>
														<div className="d-flex align-items-center mb-3">
															...
															<div className="flex-fill ps-2">
																...
																<div className="small text-white text-opacity-50">March 16</div>
															</div>
														</div>
														...
														<div className="row text-center fw-bold">
															<div className="col">
																<a href="#/" className="text-white text-opacity-50 text-decoration-none d-block p-2">
															...
															<div className="flex-fill ps-2">
																<div className="position-relative d-flex align-items-center">
																	...
																	<div className="position-absolute end-0 text-center">
																		<a href="#/" className="text-white text-opacity-50 me-2"><i className="fa fa-smile"></i></a>
																		<a href="#/" className="text-white text-opacity-50 me-2"><i className="fa fa-camera"></i></a>
																		<a href="#/" className="text-white text-opacity-50 me-2"><i className="fa fa-video"></i></a>
																		<a href="#/" className="text-white text-opacity-50 me-3"><i className="fa fa-paw"></i></a>
																	</div>
																</div>
															</div>
														</div>
													...
													<CardBody>
														<div className="d-flex align-items-center mb-3">
															...
															<div className="flex-fill ps-2">
																...
																<div className="small text-white text-opacity-50">March 12</div>
															</div>
														</div>
													...
													<CardBody>
														<div className="d-flex align-items-center mb-3">
															...
															<div className="flex-fill ps-2">
																...
																<div className="small text-white text-opacity-50">March 4</div>
															</div>
														</div>
													...
													<CardBody>
														<div className="d-flex align-items-center mb-3">
															...
															<div className="flex-fill ps-2">
																...
																<div className="small text-white text-opacity-50">May 5</div>
															</div>
														</div>
											...
											<div className="tab-pane fade" id="profile-followers">
												<div className="list-group">
													<div className="list-group-item d-flex align-items-center">
														...
														<div className="flex-fill px-3">
															<div><a href="#/" className="text-white fw-bold text-decoration-none">Ethel Wilkes</a></div>
															<div className="text-white text-opacity-50 fs-13px">North Raundspic</div>
														</div>
													...
													<div className="list-group-item d-flex align-items-center">
														...
														<div className="flex-fill px-3">
															<div><a href="#/" className="text-white fw-bold text-decoration-none">Shanaya Hansen</a></div>
															<div className="text-white text-opacity-50 fs-13px">North Raundspic</div>
														</div>
														<a href="#/" className="btn btn-outline-theme">Follow</a>
													</div>
													<div className="list-group-item d-flex align-items-center">
														...
														<div className="flex-fill px-3">
															<div><a href="#/" className="text-white fw-bold text-decoration-none">James Allman</a></div>
															<div className="text-white text-opacity-50 fs-13px">North Raundspic</div>
														</div>
														<a href="#/" className="btn btn-outline-theme">Follow</a>
													</div>
													<div className="list-group-item d-flex align-items-center">
														...
														<div className="flex-fill px-3">
															<div><a href="#/" className="text-white fw-bold text-decoration-none">Marie Welsh</a></div>
															<div className="text-white text-opacity-50 fs-13px">Crencheporford</div>
														</div>
														<a href="#/" className="btn btn-outline-theme">Follow</a>
													</div>
													<div className="list-group-item d-flex align-items-center">
														...
														<div className="flex-fill px-3">
															<div><a href="#/" className="text-white fw-bold text-decoration-none">Lamar Kirkland</a></div>
															<div className="text-white text-opacity-50 fs-13px">Prince Ewoodswan</div>
														</div>
														<a href="#/" className="btn btn-outline-theme">Follow</a>
													</div>
													<div className="list-group-item d-flex align-items-center">
														...
														<div className="flex-fill px-3">
															<div><a href="#/" className="text-white fw-bold text-decoration-none">Bentley Osborne</a></div>
															<div className="text-white text-opacity-50 fs-13px">Red Suvern</div>
														</div>
														<a href="#/" className="btn btn-outline-theme">Follow</a>
													</div>
													<div className="list-group-item d-flex align-items-center">
														...
														<div className="flex-fill px-3">
															<div><a href="#/" className="text-white fw-bold text-decoration-none">Ollie Goulding</a></div>
															<div className="text-white text-opacity-50 fs-13px">Doa</div>
														</div>
														<a href="#/" className="btn btn-outline-theme">Follow</a>
													</div>
													<div className="list-group-item d-flex align-items-center">
														...
														<div className="flex-fill px-3">
															<div><a href="#/" className="text-white fw-bold text-decoration-none">Hiba Calvert</a></div>
															<div className="text-white text-opacity-50 fs-13px">Stemunds</div>
														</div>
														<a href="#/" className="btn btn-outline-theme">Follow</a>
													</div>
													<div className="list-group-item d-flex align-items-center">
														...
														<div className="flex-fill px-3">
															<div><a href="#/" className="text-white fw-bold text-decoration-none">Rivka Redfern</a></div>
															<div className="text-white text-opacity-50 fs-13px">Fallnee</div>
														</div>
														<a href="#/" className="btn btn-outline-theme">Follow</a>
													</div>
													<div className="list-group-item d-flex align-items-center">
														...
														<div className="flex-fill px-3">
															<div><a href="#/" className="text-white fw-bold text-decoration-none">Roshni Fernandez</a></div>
															<div className="text-white text-opacity-50 fs-13px">Mount Lerdo</div>
														</div>
														<a href="#/" className="btn btn-outline-theme">Follow</a>
													</div>
												</div>
												<div className="text-center p-3"><a href="#/" className="text-white text-decoration-none">Show more <b className="caret"></b></a></div>
											</div>
											...
											<Card className="mb-3">
												<div className="list-group list-group-flush">
													<div className="list-group-item fw-bold px-3 d-flex">
														...
														<a href="#/" className="text-white text-opacity-50"><i className="fa fa-cog"></i></a>
													</div>
													<div className="list-group-item px-3">
														<div className="text-white text-opacity-50"><small><strong>Trending Worldwide</strong></small></div>
														<div className="fw-bold mb-2">#BreakingNews</div>
														<Card className="text-white text-decoration-none mb-1">
															<CardBody>
																<div className="row no-gutters">
																	<div className="col-md-8">
																		<div className="small text-white text-opacity-50 mb-1 mt-n1">Space</div>
														...
														<div><small className="text-white text-opacity-50">1.89m share</small></div>
													</div>
													<div className="list-group-item px-3">
														...
														<div><small className="text-white text-opacity-50"><i className="fa fa-external-link-square-alt"></i> Promoted by HUD Trolls</small></div>
													</div>
													<div className="list-group-item px-3">
														<div className="text-white text-opacity-50"><small><strong>Trending Worldwide</strong></small></div>
														...
														<div><small className="text-white text-opacity-50">49.3m share</small></div>
													</div>
													<div className="list-group-item px-3">
														<div className="text-white text-opacity-50"><small><strong>Trending in New York</strong></small></div>
														<div className="fw-bold mb-2">#CoronavirusPandemic</div>
														<Card className="mb-1 text-white text-decoration-none">
															<CardBody>
																<div className="row no-gutters">
																	<div className="col-md-8">
																		<div className="fs-12px text-white text-opacity-50 mt-n1">Coronavirus</div>
														...
														<div><small className="text-white text-opacity-50">821k share</small></div>
													</div>

							...
							<div id="checkboxes" className="mb-5">
								...
								<Card>
									<CardBody>
										<div className="row mb-n3">
											<div className="col-xl-6">
												<div className="small text-white text-opacity-50 mb-1"><b>DEFAULT CHECKBOX</b></div>
											...
											<div className="col-xl-6">
												<div className="small text-white text-opacity-50 mb-1"><b>INLINE CHECKBOX</b></div>
												<div className="form-group mb-3">
							...
							<div id="radios" className="mb-5">
								...
								<Card>
									<CardBody>
										<div className="row mb-n3">
											<div className="col-xl-6">
												<div className="small text-white text-opacity-50 mb-1"><b>DEFAULT RADIO</b></div>
												<div className="form-group mb-4">
													<div className="form-check">
											...
											<div className="col-xl-6">
												<div className="small text-white text-opacity-50 mb-1"><b>INLINE RADIO</b></div>
												<div className="form-group mb-3">
													<div className="form-check form-check-inline">
							...
							<div id="selectMenu" className="mb-5">
								...
								<Card>
									<CardBody>
										<div className="row">
											<div className="col-xl-6">
												<div className="small text-white text-opacity-50 mb-2"><b>DEFAULT</b></div>
											...
											<div className="col-xl-6">
												<div className="small text-white text-opacity-50 mb-2"><b>SIZING</b></div>
												<select className="form-select form-select-lg mb-3" defaultValue="">
													<option value="">Open this select menu</option>
													<option value="1">One</option>
													<option value="2">Two</option>
